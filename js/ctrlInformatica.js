app.controller('informaticaCtrl', function($scope, $rootScope, $routeParams, $location, $http, $sce) {
  ...
  let pages = [{
    ...
    painter:  function(db) {
                let content = partitionDates(db.esperience, function(x) {
                  return x.type == "Event";
                });
                addByKeyword(content, db.esperience, false, formatOther, function(x) {
